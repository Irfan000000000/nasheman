  ...
  return axios.post(API_URL + 'login', { username, password })
    .then(response => {
      if (response.data.token) {
        ...
        localStorage.setItem('campus_id', JSON.stringify(response.data.user.campus_id));
        localStorage.setItem('campus_name', JSON.stringify(response.data.user.campus_name));
        localStorage.setItem('campus_code', JSON.stringify(response.data.user.campus_code));
